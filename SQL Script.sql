...
SELECT FULL_DELIVERY_LIST_CLEANED.SUBJECT_ID, MIN(CHARTTIME),DELIVERY_TYPE,VALUE AS VALUE_4183,
julianday(CHARTEVENTS.CHARTTIME)-julianday(ADMISSIONS.ADMITTIME) AS DIFFERENCE
FROM FULL_DELIVERY_LIST_CLEANED
LEFT JOIN ADMISSIONS
ON FULL_DELIVERY_LIST_CLEANED.SUBJECT_ID= ADMISSIONS.SUBJECT_ID
...
SELECT FULL_DELIVERY_LIST_CLEANED.SUBJECT_ID, MIN(CHARTTIME),DELIVERY_TYPE,VALUE AS VALUE_3723
julianday(CHARTEVENTS.CHARTTIME)-julianday(ADMISSIONS.ADMITTIME) AS DIFFERENCE
FROM FULL_DELIVERY_LIST_CLEANED
LEFT JOIN ADMISSIONS
ON FULL_DELIVERY_LIST_CLEANED.SUBJECT_ID= ADMISSIONS.SUBJECT_ID
...
SELECT FULL_DELIVERY_LIST_CLEANED.SUBJECT_ID, MIN(CHARTTIME),DELIVERY_TYPE,VALUE AS VALUE_3580,
julianday(CHARTEVENTS.CHARTTIME)-julianday(ADMISSIONS.ADMITTIME) AS DIFFERENCE
FROM FULL_DELIVERY_LIST_CLEANED
LEFT JOIN ADMISSIONS
ON FULL_DELIVERY_LIST_CLEANED.SUBJECT_ID= ADMISSIONS.SUBJECT_ID
...
SELECT DISTINCT(FINALNEWBORNLIST.SUBJECT_ID)
FROM FINALNEWBORNLIST
LEFT JOIN CHARTEVENTS
ON FINALNEWBORNLIST.SUBJECT_ID=CHARTEVENTS.SUBJECT_ID
